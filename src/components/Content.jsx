...
function Content(){
    return(
        <div className="content">
            ...
            <p className="p1">Was released in 2013</p>
            <p className="p2">Was originally created by Jordan Walke</p>
            <p className="p3"> Has well over 100k stars on github</p>
            <p className="p4">is maintained by meta</p>

            </div>
            <div className="react-logo2" >
                <svg xmlns="http://www.w3.org/2000/svg" width="263" height="263" viewBox="0 0 29 29" fill="none">
